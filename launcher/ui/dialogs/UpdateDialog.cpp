...
void UpdateDialog::loadChangelog()
{
    ...
    if(channel == "stable")
    {
        url = QString("https://raw.githubusercontent.com/graytoowolf/Launcher-Cracked/%1/changelog.md").arg(channel);
        m_changelogType = CHANGELOG_MARKDOWN;
    }
    else
    {
        url = QString("https://api.github.com/repos/graytoowolf/Launcher-Cracked/compare/%1...%2").arg(BuildConfig.GIT_COMMIT, channel);
